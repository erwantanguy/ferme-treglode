...
<title>Livre d'or - Centre équestre - Ferme Le Tréglodé</title>
...
<dd><!-- menu réalisé par Thomas Dedericks, soumis à licence Creative Commons "by" et consultable ici http://css.alsacreations.com/Tutoriels-JavaScript/Creer-un-menu-accordeon-avec-jQuery  class="open_at_load"-->
            	<ul id="navigation">
        <li class="toggleSubMenu2"><a href="http://www.ferme-letreglode.fr/index.html" title="accueil">accueil</a></li>
        ...
        <li class="toggleSubMenu2"><a href="http://www.ferme-letreglode.fr/stages.html" title="stages">stages</a>
        </li>
        <li class="toggleSubMenu2"><a href="http://www.ferme-letreglode.fr/randonnees.html" title="randonnées">randonnées</a>
        </li>
        <li class="toggleSubMenu2"><a href="http://www.ferme-letreglode.fr/accueilgroupe.html" title="accueil de groupe">accueil de groupe</a>
        </li>
    </ul>  
           </dd>
        </dl>
        ...
        <div id="content">
			...
			<div id="texte"><h1>livre d'or de la ferme équestre</h1>
                <h2>le tréglodé</h2>
                <div class="formulaire"><form action="message.php" method="post">
<div>
...
<div class="formulaire"><?php $consultez="livredor.txt"; readfile($consultez); ?></div>
           </div>            <div id="menuD">
            	<ul class="second">
                  ...
                  <li class="news"><a href="http://www.ferme-letreglode.fr/newsletter.html"><img src="images/pucecarre_vertf.gif" alt="puce verte" /> newsletter</a></li>
                	...
                	<div class="info">
                        ...
                        <li><a href="http://www.ferme-letreglode.fr/livredor" class="open">Livre d'or</a></li>
